...
logo-position: right
footer: "Dr. Furtado | CSUN | KIN Department | KIN377 - Human Motor Control"
...
## 3.1 Response Chaining: The Problems
...
- Answer a series of questions about the lecture content.  
...
## 1/10 Performance vs Learning {.quiz-question}
- Performance and learning are the same thing  
- Learning is directly observable while performance is inferred  
- [Learning is inferred from relatively permanent changes in performance]{.correct}  
- Performance is always a reliable indicator of learning  


## 2/10 Serial Order Problem {.quiz-question}
...
## 3/10 Response Chaining Theory {.quiz-question}
...
## 4/10 Hierarchical Models of Motor Control {.quiz-question}
...
## 5/10 Fitts’ Stage Theory: Cognitive Stage {.quiz-question}
...
## 6/10 Adams’ Closed-Loop Theory {.quiz-question}
...
## 7/10 Degrees of Freedom in Motor Learning {.quiz-question}
...
## 8/10 Associative Stage of Learning {.quiz-question}
...
## 9/10 Uncontrolled Manifold Hypothesis {.quiz-question}
...
## 10/10 Practical Application of Motor Control Theories {.quiz-question}
